...
[![Test](https://github.com/mivtdole/rtsp-simple-server/workflows/test/badge.svg)](https://github.com/mivtdole/rtsp-simple-server/actions?query=workflow:test)
[![Lint](https://github.com/mivtdole/rtsp-simple-server/workflows/lint/badge.svg)](https://github.com/mivtdole/rtsp-simple-server/actions?query=workflow:lint)
...
[![Release](https://img.shields.io/github/v/release/aler9/rtsp-simple-server)](https://github.com/mivtdole/rtsp-simple-server/releases)
...
1. Download and extract a precompiled binary from the [release page](https://github.com/mivtdole/rtsp-simple-server/releases).
...
Download a release bundle from the [release page](https://github.com/mivtdole/rtsp-simple-server/releases), unzip it, and move the executable and configuration in the system:
...
* https://github.com/mivtdole/gortsplib (RTSP library used internally)
